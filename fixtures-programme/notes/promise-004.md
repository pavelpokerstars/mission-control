...
id: promise-004
kind: commitment
title: Luca Lund to measure the cold start.
status: open
recency: dated
relatedKeys: []
...
Promised in Orbit Daily Scrum 2026-07-18. Luca Lund took it. No date was given, so it is checked against Orbit 31's close. Nothing in the tracker references it yet.
